...
(function() {
    ...
    window.OPAY_FINANCE_CONFIG = {
        roles_definition: {
            ...
            USER: { code: 'USER', name: 'General User', permissions: ['PRODUCT_MGMT:L1_PRODUCT:VIEW', 'PRODUCT_MGMT:L2_ITEM:VIEW', 'FIXED_OPS:SPECIAL_PLAN:VIEW', 'KA_FIXED_OPS:PLAN:VIEW', 'TARGET_OPS:KA_WHITELIST:VIEW'] }
        },
        users: [
