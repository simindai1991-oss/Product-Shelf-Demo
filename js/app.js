    ...
    template: `
        ...
        <div class="flex flex-1 overflow-hidden bg-gray-50">
            ...
            <main class="flex-1 overflow-auto p-8 relative">
                ...
                <TargetTemplateManager v-if="currentView === 'target_ops'" :templates="targetTemplates" :items="savingItems" @create-template="handleCreateTemplate" @update-template="handleUpdateTemplate" />
                ...
                <UserManagement v-if="currentView === 'users'" :users="usersList" :roles="rolesList" :has-permission="hasPermission" @add-user="handleAddUser" @update-role="handleUpdateUserRole" />
